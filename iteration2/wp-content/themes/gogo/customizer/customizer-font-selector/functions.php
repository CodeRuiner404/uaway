 ...
 * @since 1.1.38
 */
function gogo_get_standard_fonts(){
 ...
 * @since 1.1.38
 */
function gogo_enqueue_google_font($font){
	...
	$subsets        = '';
	$get_subsets    = get_theme_mod( 'gogo_font_subsets', array( 'latin' ) );
	...
	// Enqueue style
	wp_enqueue_style( 'gogo-google-font-' . $handle, $url, array(), false );
}