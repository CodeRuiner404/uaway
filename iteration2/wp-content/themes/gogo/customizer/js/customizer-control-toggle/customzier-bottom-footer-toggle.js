...
ZTACustomizerToggles ['gogo_bottom_footer_layout'] = [
		    {
				controls: [ 
				'gogo_bottom_footer_col1_set',
				'gogo_footer_bottom_col1_texthtml',
				'gogo_footer_bottom_col1_widget_redirect',
				'gogo_footer_bottom_col1_menu_redirect',
				'gogo_footer_bottom_col1_social_media_redirect',
				'gogo_bottom_footer_col2_set', 
				'gogo_bottom_footer_col2_texthtml',
				'gogo_bottom_footer_col2_widget_redirect',
				'gogo_bottom_footer_col2_menu_redirect',
				'gogo_bottom_footer_col2_social_media_redirect',
				'gogo_bottom_footer_col3_set',
				'gogo_bottom_footer_col3_texthtml',
				'gogo_bottom_footer_col3_widget_redirect',
				'gogo_bottom_footer_col3_menu_redirect',
				'gogo_bottom_footer_col3_social_media_redirect',
				'gogo_btm_ftr_hgt',
				'gogo_bottom_frt_brdr_clr',
				'gogo_btm_ftr_botm_brd',
				'gogo_bottom_footer_color_scheme',
				],
...
// col1
			{
				...
				callback: function(layout){
					var val = api( 'gogo_bottom_footer_col1_set' ).get();
...
// col2
			{
				...
				callback: function(layout){
					var val = api( 'gogo_bottom_footer_col2_set' ).get();
			...
			// col3
			{
				...
				callback: function(layout){
					var val = api( 'gogo_bottom_footer_col3_set' ).get();
...
ZTACustomizerToggles ['gogo_bottom_footer_col1_set'] = [
			{
				controls: [    
				'gogo_footer_bottom_col1_texthtml',
				],
				callback: function(layout){
					var val = api( 'gogo_bottom_footer_layout' ).get();
...
ZTACustomizerToggles ['gogo_bottom_footer_col2_set'] = [
		    {
				controls: [    
				'gogo_bottom_footer_col2_texthtml',
				'gogo_bottom_footer_col2_widget_redirect',
...
ZTACustomizerToggles ['gogo_bottom_footer_col3_set'] = [
		    {
				controls: [    
				'gogo_bottom_footer_col3_texthtml',
				'gogo_bottom_footer_col3_widget_redirect',
