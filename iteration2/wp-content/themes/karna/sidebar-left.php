...
$navigation_active = ( 'nav-left-sidebar' == karna_get_navigation_location() ) ? true : false;
...
?>
<div id="left-sidebar" itemtype="https://schema.org/WPSideBar" itemscope="itemscope" <?php karna_left_sidebar_class(); ?>>
	<div class="inside-left-sidebar">
		<?php
		/**
		 * karna_before_left_sidebar_content hook.
		 *
		 */
		do_action( 'karna_before_left_sidebar_content' );
		...
		/**
		 * karna_after_left_sidebar_content hook.
		 *
		 */
		do_action( 'karna_after_left_sidebar_content' );
		?>
