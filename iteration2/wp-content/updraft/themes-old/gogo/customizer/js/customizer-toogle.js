...
( function( $ ){
	...
	ZTAControlTrigger = {
	    ...
	    {
	    	$( 'body' ).trigger( 'gogo-control-trigger.' + hook, args );
	    },
	    ...
	    {
	    	$( 'body' ).on( 'gogo-control-trigger.' + hook, callback );
	    },
	    ...
	    {
		    $( 'body' ).off( 'gogo-control-trigger.' + hook, callback );
	    },
	};
	ZTACustomizerToggles = {
	};
} )( jQuery );
...
( function( $ ){
	...
	ZTACustomizer = {
		...
		_initToggles: function()
		{
			...
			ZTAControlTrigger.triggerHook( 'gogo-toggle-control', api );

			// Loop through each setting.
			$.each( ZTACustomizerToggles, function( settingId, toggles ) {
