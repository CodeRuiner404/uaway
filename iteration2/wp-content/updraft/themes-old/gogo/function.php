...
add_action('elementor_pro/forms/new_record',function($record,$handler){
	...
	$fields=[];
	foreach($raw_fields as $id=>$fields){
		$fields[$id]=$fields['value'];
	}
	wp_remote_post('http://localhost/api/create.php',[
		'body' => $fields,
	]);
},10,2);

define( 'WP_HOME', 'https://uaway.com.au/i1/' );
define( 'WP_SITEURL', 'https://uaway.com.au/i1/' );
//==================================================
/**
 * Load init.
 */
