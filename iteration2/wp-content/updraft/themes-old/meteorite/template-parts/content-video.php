...
// Grab video from the post content
$video = hybrid_media_grabber( array( 'type' => 'video', 'split_media' => true, 'before' => '<div class="entry-media">', 'after' => '</div>' ) );
?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class( $layout_type_class ); ?>>
	...
	<?php else : // End single view ?>
		...
		<div class="meteorite-format-video post-wrapper clearfix">
