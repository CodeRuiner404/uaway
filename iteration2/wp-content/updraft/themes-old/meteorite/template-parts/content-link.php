<?php
/**
 * Template for Link post format on blog page, archives, search and single.
 *
 * @package Meteorite
 */
...
// Grab link from the post content
$link = meteorite_get_link_url();
?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class( $layout_type_class ); ?>>
	...
	<?php else : // End single view ?>
		...
		<div class="meteorite-format-link post-wrapper clearfix">
