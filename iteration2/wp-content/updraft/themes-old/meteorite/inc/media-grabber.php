...
/**
 * Wrapper function for the Hybrid_Media_Grabber class. Returns the raw shortcode for the found media without applying do_shortcode().
 *
 * @since  2.0.0
 * @access public
 * @param  array
 * @return string
 */
function hybrid_media_grabber_raw( $args = array() ) {

	$media = new Hybrid_Media_Grabber( $args );

	return $media->original_media;
}
