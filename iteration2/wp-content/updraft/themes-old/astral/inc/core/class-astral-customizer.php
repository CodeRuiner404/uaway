...
class astral_Customizer extends astral_Abstract_Main {
	...
	function astral_customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting( 'astral_inner_header',
			array(
				'type'              => 'theme_mod',
				'default'           => '1',
				'sanitize_callback' => 'astral_sanitize_checkbox'
		...
		$wp_customize->add_control( new astral_Toggle_Switch_Custom_control( $wp_customize, 'astral_inner_header',
			array(
				'label' => __( 'Inner Header Display On/Off', 'astral' ),
				'section' => 'astral_general_settings'
			)
		) );
