...
class Meteorite_Page_Metabox {
	...
	public function save( $post_id ) {
		...
		$meteorite_image_header_title 		= isset( $_POST['meteorite_image_header_title'] ) ? wp_kses_post( $_POST['meteorite_image_header_title'] ) : false;
		...
		$meteorite_image_header_text 		= isset( $_POST['meteorite_image_header_text'] ) ? wp_kses_post( $_POST['meteorite_image_header_text'] ) : false;
