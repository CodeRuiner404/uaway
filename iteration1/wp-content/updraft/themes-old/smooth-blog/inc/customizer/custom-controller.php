 ...
 * @since  1.0.0
 */
class Smooth_Blog_Separator_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
	 */
	public $type = 'smooth-blog-separator';
	/**
	 * Control method
	 *
	 * @since 1.0.0
 ...
 * @access public
 */
class Smooth_Blog_Customize_Control_Radio_Color extends WP_Customize_Control {
...
$wp_customize->register_control_type( 'smooth_blog_Customize_Control_Radio_Color');

class Smooth_Blog_Customize_Control_Sort_Sections extends WP_Customize_Control {
