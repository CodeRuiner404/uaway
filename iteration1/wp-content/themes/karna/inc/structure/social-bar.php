...
if ( ! function_exists( 'karna_social_bar' ) ) {
	add_action( 'karna_social_bar_action', 'karna_social_bar' );
	function karna_social_bar() {
		$socials_facebook_url  		=  karna_get_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  karna_get_setting( 'socials_twitter_url' );
		$socials_google_url    		=  karna_get_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  karna_get_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  karna_get_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  karna_get_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  karna_get_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  karna_get_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  karna_get_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  karna_get_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  karna_get_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  karna_get_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  karna_get_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  karna_get_setting( 'socials_mail_url' );
	?>
