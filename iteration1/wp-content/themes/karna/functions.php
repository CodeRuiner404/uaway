...
define( 'KARNA_VERSION', '1.1.0' );

if ( ! function_exists( 'karna_setup' ) ) {
	add_action( 'after_setup_theme', 'karna_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function karna_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'karna' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'karna' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in karna_smart_content_width()
		 */
...
define('KARNA_THEME_URL','https://wpkoi.com/karna-wpkoi-wordpress-theme/');
define('KARNA_WPKOI_AUTHOR_URL','https://wpkoi.com/');
define('KARNA_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/');
define('KARNA_WORDPRESS_REVIEW','https://wordpress.org/support/theme/karna/reviews/?filter=5');
define('KARNA_DOCUMENTATION','https://wpkoi.com/docs/');
define('KARNA_FONT_AWESOME_LINK','https://wpkoi.com/docs/custom-icons/');
