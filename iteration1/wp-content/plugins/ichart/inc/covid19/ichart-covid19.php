	...
	class IchartCovid19 {
		...
		<div class="small-12">
			<div class="small-12 cell">
				<h3><?php esc_html_e('Widget Shortcode', 'qc-ichart'); ?></h3>
			</div>
			<div class="small-12 cell"><?php _e('<b>land:</b> NorthAmerica / SouthAmerica / Africa / Asia / Europe / Oceania', 'qc-ichart'); ?>.</div>
			<div class="small-12 cell">
				<h4><?php esc_html_e('Countries:', 'qc-ichart'); ?></h4>
			</div>
			<div class="small-12 cell">
				<select name="covid_country">
					<option value=""><?php esc_html_e('All Countries - Worldwide Statistics', 'qc-ichart'); ?></option>
					<?php
			...
			<p id="covidsh" class="covid_shortcode" contenteditable="true"><?php esc_html_e('[QCLDCOVID19-WIDGET title_widget="Worldwide" land="" confirmed_title="Cases" deaths_title="Deaths" recovered_title="Recovered"]', 'qc-ichart'); ?></p>
		</div>
		...
		<div class="grid-x display-required callout" style="opacity: 1; pointer-events: inherit;">
			<div class="small-12 cell">
				<h3><?php esc_html_e('Data Ticker', 'qc-ichart'); ?></h3>
			</div>
			<div class="small-12 cell"><small><?php _e('Paste this shortcode into <b>Sidebar Text widget</b>.', 'qc-ichart'); ?></small></div>
			<div class="small-12 cell"><?php _e('Use <b>style="horizontal"</b> for Horizontal style.', 'qc-ichart'); ?></div>
			<div class="small-12 cell">
				<h4><?php esc_html_e('Countries:', 'qc-ichart'); ?></h4>
			</div>
			<div class="small-12 cell">
			...
			<p id="covidsh-ticker" class="covid_shortcode" contenteditable="true"><?php _e('[QCLDCOVID19-TICKER ticker_title="World" style="vertical" confirmed_title="Confirmed" deaths_title="Deaths" recovered_title="Recovered"]', 'qc-ichart'); ?></p>
		</div>
